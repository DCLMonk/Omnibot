...
#INC=-I/home/forrest/Documents/house_project
...
#	-Wa,-ahlms=$(firstword                  \
#	$(filter %.lst, $(<:.c=.lst)))
CFLAGS=-I. $(INC) -g -mmcu=$(MCU) -O$(OPTLEVEL) -Wall 
	    				\
...
.PHONY: writeflash clean stats gdbinit stats prog fuses
...
writeflash: hex
	$(AVRDUDE) -c $(AVRDUDE_PROGRAMMERID)   \
	 -p $(PROGRAMMER_MCU) -P $(AVRDUDE_PORT) -e -F     \
...
read-fuses:
	$(AVRDUDE) -c $(AVRDUDE_PROGRAMMERID)   \
	 -p $(PROGRAMMER_MCU) -P $(AVRDUDE_PORT) \
	 -U lfuse:r:low.hex:i -U hfuse:r:high.hex:i

prog: clean all writeflash
prog: clean all writeflash
